    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center">
        <Card
          ...
          description="In the first phase, we focus on understanding the project requirements and planning a strategy to ensure success."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          title="Development & Progress Upgrade"
          icon={<AceternityIcon order="Phase2" />}
          description="During the second phase, the development begins with continuous monitoring and regular progress upgrades."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="In the final phase, we finalize the development and prepare for a successful product launch."
        >
          <CanvasRevealEffect
            animationSpeed={3}
